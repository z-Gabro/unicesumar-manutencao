            ...
            <div class="card o-hidden border-0 shadow-lg my-2">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Insira abaixo os dados do cliente</h1>
                                </div>

                                <!-- Formulário -->
                                <form class="user" action="{{ route('admin.clientes.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nome"
                                            ...
                                            id="clienteNome" placeholder="Nome" value="{{ old('nome') }}" maxlength="60"
                                            required>
                                        @error('nome')
                                    ...
                                    <!-- Campo Telefone -->
                                    <div class="form-group">
                                        <label for="clienteTelefone">Telefone (Celular)*</label>
                                    ...
                                    @if ($errors->has('data_nascimento') or $errors->has('apelido') or
                                    $errors->has('data_nascimento'))
                                    <!-- Botão Exibir Campos Opcionais (com erro)-->
                                    <div class="mb-3">
                                        <a class="btn btn-outline-danger btn-sm" data-toggle="collapse"
                                            href="#multiCollapseCamposOpcionais" role="button" aria-expanded="false">
                                            Exibir campos opcionais
                                            <i class="fa fa-exclamation-circle" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                    @else
                                    <!-- Botão Exibir Campos Opcionais (sem erro)-->
                                    <div class="mb-3">
                                    ...
                                    <div class="collapse multi-collapse" id="multiCollapseCamposOpcionais">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="data_nascimento"
                                                ...
                                                id="clienteDataNascimento" value="{{ old('data_nascimento') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="apelido"
                                                ...
                                                id="clienteApelido" placeholder="Apelido" value="{{ old('apelido') }}"
                                                maxlength="60">
                                            @error('apelido')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                        ...
                        <!-- Ilustração -->
                        <div class="col-lg-6 d-none d-lg-block bg-create-cliente-image"></div>
